      ...
      <div className="px-4 py-5 border-b border-gray-800">
        <div className="flex items-center gap-2.5">
          ...
          >
            ...
            {/* Leaf */}
            <path
              d="M32 8 C28 4 22 5 22 9 C22 13 28 12 32 8Z"
              fill="url(#sbLeafGrad)"
            />
            {/* Body */}
            <path
              d="M32 8 C38 9 44 17 44 28 C44 38 40 47 36 53 C34 57 32 59 31 56 C30 53 27 47 26 40 C24 31 24 19 28 11 C29 9 30 8 32 8Z"
              fill="url(#sbPepperGrad)"
            />
            {/* Highlight */}
            <path
              d="M30 13 C28 20 27 29 28 38"
              fill="none"
              stroke="white"
              strokeWidth="1.8"
              strokeLinecap="round"
